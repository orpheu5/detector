...
public class ByteImageFactory {
    public static ByteImage instanceFromFile(File f, char oneChar, char zeroChar, char maskChar) throws IllegalArgumentException, IOException{
        return instanceFromReader(new FileReader(f),f.getName(), oneChar, zeroChar, maskChar);
    }

    public static ByteImage instanceFromReader(InputStreamReader in, String name, char oneChar, char zeroChar, char maskChar) throws IllegalArgumentException, IOException{
